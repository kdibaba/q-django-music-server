...
#    (r'^view_tv_shows/$',                       'Catalog.tv_shows.views.view_tv_shows'),
#    (r'^view_tv_show/(?P<show_id>\d+)/$',       'Catalog.tv_shows.views.view_tv_show'),
#    (r'^search_tv_shows/$',                     'Catalog.tv_shows.views.search_tv_shows'),
#    (r'^add_episodes/(?P<show_id>\d+)/$',       'Catalog.tv_shows.views.add_episodes'),
#    (r'^fix_eps/$',                             'Catalog.tv_shows.views.fix_eps'),
#    
